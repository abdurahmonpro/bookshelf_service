...
func (x *CreateBook) GetPublished() int32 {
	if x != nil {
		return x.Published
	}
	return 0
...
type UpdateBook struct {
	...
	Cover     string `protobuf:"bytes,4,opt,name=cover,proto3" json:"cover,omitempty"`
	Author    string `protobuf:"bytes,5,opt,name=author,proto3" json:"author,omitempty"`
	Published int32  `protobuf:"varint,6,opt,name=published,proto3" json:"published,omitempty"`
	Pages     int32  `protobuf:"varint,7,opt,name=pages,proto3" json:"pages,omitempty"`
	Status    int32  `protobuf:"varint,8,opt,name=status,proto3" json:"status,omitempty"` // 0-new, 1-reading, 2-finished,
}
...
func (x *UpdateBook) GetPublished() int32 {
	if x != nil {
		return x.Published
	}
	return 0
...
var file_book_proto_rawDesc = []byte{
	...
	0x62, 0x6c, 0x69, 0x73, 0x68, 0x65, 0x64, 0x18, 0x05, 0x20, 0x01, 0x28, 0x05, 0x52, 0x09, 0x70,
	...
	0x09, 0x70, 0x75, 0x62, 0x6c, 0x69, 0x73, 0x68, 0x65, 0x64, 0x18, 0x06, 0x20, 0x01, 0x28, 0x05,
